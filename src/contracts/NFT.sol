...
contract RealEstateNFT is PropertyNFT {
    ...
    function requestToMintNewRealEstateToken(string memory name) public returns (bytes32){
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        properties.push(
            Property({
                ...
                leases: leases,
                geoLocation:Location({latitude: randomLatitude, longitude: randomLogitude}),
